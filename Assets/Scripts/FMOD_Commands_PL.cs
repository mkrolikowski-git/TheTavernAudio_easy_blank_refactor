...
//        FootstepsSound.setParameterByNameWithLabel("Foot_Surface", "Stone"); // Ustawia parametr o nazwie "Footsteps_surface" na wartość "Stone".
...
//        FootstepsSound.setParameterByNameWithLabel("Foot_Surface", "Stone");
